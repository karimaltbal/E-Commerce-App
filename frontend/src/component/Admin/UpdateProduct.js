...
import { clearError, updateProduct, detailsProductAction } from "../../redux/actions/productActions";
...
const UpdateProduct = () => {
    ...
    const { error, productData } = useSelector((state) => state.productDetails);
    ...
    }, [dispatch, alert, navigate, isUpdated, productId, updateError, productData, error]);
